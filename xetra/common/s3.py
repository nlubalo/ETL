"""
Connectors and methods accessing S3
"""
import os
import logging
import boto3
...
class S3BucketConnector:
    ...
    def list_files_in_prefix(self, prefix: str):
        """
        listing all files with a prefix in s3 bucket
        param prefix: Prefix on s3 bucket that should be filtered
        returns files that should
        """
